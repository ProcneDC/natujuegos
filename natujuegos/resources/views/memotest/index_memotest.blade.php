...
<head>
  ...
  <link rel="stylesheet" href="memotest/css/animate.min.css">
  <link rel="stylesheet" href="memotest/css/styles.css">
</head>
<body>
<!--  cz-shortcut-listen="true": is inserted into html by the colorzilla extension/add-on-->  
  <header>
    <figure>
      <img id="logo" src="img/Angry.png" alt="logo">
    </figure>
  </header>
  <div class="arreglar">      
    <div class="column">
...
<script src="memotest/js/jquery.js"></script>
<script src="memotest/js/index.js"></script>
</body>
</html>